...
public class PersistentCookieStore implements NCookieStore<Cookie>{
    ...
    public List<Cookie> get(URI uri){
        ...
        {
            Collection<Cookie> cookies = this.cookies.get(uri.getHost()).values();
            for (Cookie cookie : cookies)
            {
